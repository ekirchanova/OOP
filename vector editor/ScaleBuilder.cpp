...
std::shared_ptr<Command> ScaleBuilder::creator_command(const std::vector<std::string>& cur_data)
{
	...
	return std::make_shared<Scale>(type_name_shape, first_change, second_change);
}